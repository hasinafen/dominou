      ...
      <div className="vuec_container">
        ...
        <div className="title">
            <div className="top">
              ...
              <div className="score">
                <div className="flex">
                  <h3 className="tojo" >{props.joueur1}</h3>
                ...
                <button className="ajouter-1" onClick={onClickA} > <i className="fa fa-plus"></i> ajouter score</button>
                {
              ...
              <div className="score-1">
                ...
                <button className="ajouter-3" onClick={onClickC}><i className="fa fa-plus"></i> ajouter score</button>
                {
                  isSide === true  && <AjouterScore/>
                }
              </div>
              <div className="score-2">
                  ...
                  <div className="joint-1">
                    ...
                    <button className="details-1" onClick={onClickB}><i className="fa fa-plus"></i> ajouter score</button>
                    {
                        isHide === true  && <AjouterScore/>
                    }
                  </div> 
              </div>
