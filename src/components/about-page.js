 ...
 const about =()=>{
     return(
        ...
        <div className="about-menu">
          ...
          <button className="info"><i className="fa fa-info-circle"></i></button>
        </div>
        <div className="about-titre">
          <h2 className="about-h2">A propos</h2>
          <div className="class">
         
          </div>
          <div className="diva">
            <span> une application pour enregistre <br/>les scores de jeux dominos</span>
            <span> une application pour enregistre <br/>les scores de jeux dominos</span>
            <span> une application pour enregistre <br/>les scores de jeux dominos</span>
             
             <h3>Dévéloppé par:</h3>
              <div className="about-fini">
